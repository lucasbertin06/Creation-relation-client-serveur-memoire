...
if pid_backend == 0:
    ...
    if periodic_log:
        ...
        os.dup2(fd_log, 2)
        os.close(fd_log)
        os.execvp("python3", ["python3", "server_mem_backend.py", size_mem_str, "--periodic-log"])
    else:
        os.execvp("python3", ["python3", "server_mem_backend.py", size_mem_str])
    sys.exit(1)
...
if pid_frontend == 0:
    ...
    if debug:
        os.execvp("python3", ["python3", "server_mem_frontend.py", size_mem_str, "--debug"])
    else:
        os.execvp("python3", ["python3", "server_mem_frontend.py", size_mem_str])
    sys.exit(1)
